...
function generatePeople(r) {
    ...
    o.username = r.results[0].login.username;
    o.email = r.results[0].email;
    o.password = r.results[0].login.password;
    o.profile = {
        name: capitalizeFirstLetter(r.results[0].name.first) + ' ' + capitalizeFirstLetter(r.results[0].name.last),
        gender: r.results[0].gender.toUpperCase(),
        picture: r.results[0].picture.medium,
        location: capitalizeFirstLetter(r.results[0].location.city) + ', ' + capitalizeFirstLetter(r.results[0].location.state),
        videos: [
